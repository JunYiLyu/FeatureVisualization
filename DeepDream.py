...
#%%
import PIL
dog_img = PIL.Image.open('C:\\Users\\jx830\\OneDrive\\桌面\\trump.jpg')
tf.keras.utils.array_to_img(dog_img)
dog_img = tf.keras.applications.inception_v3.preprocess_input(np.array(dog_img))

dream_inception_dog_img = run_deep_dream_simple(dog_img, model=dream_inception_model, 
                                  steps=500, step_size=0.01)
